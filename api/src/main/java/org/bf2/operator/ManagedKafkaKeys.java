...
public final class ManagedKafkaKeys {
    ...
    static final String MK_NAMESPACE = GROUP + "/";

    public static String forKey(String key) {
        return MK_NAMESPACE + key;
    }
    ...
    public static final class Annotations {
         ...
         */
        public static final String MASTER_SECRET_DIGEST = MK_NAMESPACE + "master-secret-digest";
         ...
         */
        public static final String SECRET_DEPENDENCY_DIGEST = MK_NAMESPACE + "secret-dependency-digest";

        /**
         * Annotation containing the timestamp the operator updates the Strimzi Kafka resource
         * with a new version.
         */
        public static final String KAFKA_UPGRADE_START_TIMESTAMP = MK_NAMESPACE + "kafka-upgrade-start";

        /**
         * Annotation containing the timestamp of when the operator determines Strimzi has finished
         * upgrading the Kafka version.
         */
        public static final String KAFKA_UPGRADE_END_TIMESTAMP = MK_NAMESPACE + "kafka-upgrade-end";

        /**
         * Annotation declaring the reason Strimzi Kafka reconciliation has been paused.
         */
        public static final String STRIMZI_PAUSE_REASON = MK_NAMESPACE + "pause-reason";
         ...
         */
        public static final String KAFKA_IMAGES = MK_NAMESPACE + "kafka-images";
         ...
         */
        public static final String RELATED_IMAGES = MK_NAMESPACE + "related-images";
         ...
         */
        public static final String PAUSE_RECONCILIATION = MK_NAMESPACE + "pause-reconciliation";
    ...
    public static final class Labels {
         ...
         */
        public static final String KAS_MULTI_ZONE = MK_NAMESPACE + "kas-multi-zone";
         ...
         */
        public static final String STRIMZI_VERSION = MK_NAMESPACE + "strimziVersion";
